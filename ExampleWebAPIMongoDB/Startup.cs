...
namespace ExampleWebAPIMongoDB
{
    ...
    Configuration.GetSection(nameof(ProjMongoDotnetDatabaseSettings)));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ExampleWebAPIMongoDB", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ExampleWebAPIMongoDB v1"));
            }
